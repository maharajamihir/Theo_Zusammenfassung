...
\label{sec:org490820d}

\subsection{Grundbegriffe}
\label{sec:org9f22edb}
\begin{itemize}
...
\label{sec:org954c2ca}
\subsubsection{Satz 3.24}
\label{sec:orgca3486b}
...
\label{sec:orge62427b}
\subsubsection{Definition 3.26}
\label{sec:org7146b21}
...
\label{sec:orgea593bd}
\textbf{TODO MIA}

\subsection{Äquivalenztest von DFAs}
\label{sec:org9a6b524}
...
\label{sec:orgad24ee7}
\subsubsection{4.21}
\label{sec:org728fa0a}
